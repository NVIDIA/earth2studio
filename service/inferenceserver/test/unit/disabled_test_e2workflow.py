...
class TestEarth2Workflow:
    ...
    def test_run_method_with_io_backend_and_progress_updates(self, mock_get_config):
        ...
        with (
            ...
            mock_get_path.return_value = Path("/tmp/test_output")
...
class TestBackendProgress:
    ...
    def test_passthrough_to_underlying_io(self):
