...
E2STUDIO_VOCAB = {
    ...
    "lightning_event_count": "lightning event count (1.0 per detected optical event)",
    "lightning_event_energy": "lightning event optical energy (J)",
    "lightning_event_radiance": "lightning event optical radiance (mW m-2 sr-1)",
    "lightning_group_count": "lightning group count (1.0 per detected group)",
    "lightning_group_energy": "lightning group optical energy (J)",
    "lightning_group_radiance": "lightning group optical radiance (mW m-2 sr-1)",
    "lightning_flash_count": "lightning flash count (1.0 per detected flash)",
    "lightning_flash_energy": "lightning flash optical energy (J)",
    "lightning_flash_radiance": "lightning flash optical radiance (mW m-2 sr-1)",
    "lightning_flash_duration": "lightning flash duration (ms)",
    "lightning_flash_footprint_pixels": "lightning flash footprint size "
    "(number of instrument pixels)",
    ...
    "atms_antenna_temperature": "Advanced Technology Microwave Sounder antenna temperature (K)",
    ...
    "e06": "evaporation accumulated over past 6 hours (m of water equivalent, negative = evaporation)",
