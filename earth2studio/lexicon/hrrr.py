...
class HRRRLexicon(metaclass=LexiconType):
    ...
    def build_vocab() -> dict[str, str]:
        ...
        sfc_variables = {
            ...
            "u100m": "wrfsfc::UGRD::100 m above ground::anl",
            "v100m": "wrfsfc::VGRD::100 m above ground::anl",
...
class HRRRFXLexicon(metaclass=LexiconType):
    ...
    def build_vocab() -> dict[str, str]:
        ...
        sfc_variables = {
            ...
            "u100m": "wrfsfc::UGRD::100 m above ground",
            "v100m": "wrfsfc::VGRD::100 m above ground",
