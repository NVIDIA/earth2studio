...
class HRRR:
    ...
    Badges
    ------
    region:na dataclass:analysis dataset:hrrr product:wind product:precip product:temp product:atmos product:radar
    """
...
class HRRR_FX(HRRR):
    ...
    Badges
    ------
    region:na dataclass:simulation dataset:hrrr product:wind product:precip product:temp product:atmos product:radar
    """
