...
yaml_seed3=$(grep -oP "\['2024-09-29 00:00:00', 3, \K\d+" reproduce_helene.yaml)
yaml_seed4=$(grep -oP "\['2024-09-29 00:00:00', 4, \K\d+" reproduce_helene.yaml)
...
if [ "$seed_mem3" != "$yaml_seed3" ] || [ "$seed_mem4" != "$yaml_seed4" ]; then
    ...
    sed -i "s/\['2024-09-29 00:00:00', 3, [0-9]*\]/['2024-09-29 00:00:00', 3, $seed_mem3]/" reproduce_helene.yaml
    sed -i "s/\['2024-09-29 00:00:00', 4, [0-9]*\]/['2024-09-29 00:00:00', 4, $seed_mem4]/" reproduce_helene.yaml
fi
