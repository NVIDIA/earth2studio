...
#
# The ARCO data source provide the ERA5 dataset in a cloud optimized format, however
# only provides specific humdity. This is a problem for models that may use relative
