...
#
# - Use the `earth2studio.models.px.DLESyMLatLon` model. This version of DLESyM
...
#   internally.
# - Use the `earth2studio.models.px.DLESyM` model, and handle the regridding of
...
# data source provides lat/lon data, we can use the `earth2studio.models.px.DLESyMLatLon` model.
#
