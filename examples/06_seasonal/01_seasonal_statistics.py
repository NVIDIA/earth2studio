...
#
# - Prognostic Model: Use the built in Pangu 24 hour model `earth2studio.models.px.Pangu24`.
...
# - IO Backend: Save the outputs into a NetCDF4 store `earth2studio.io.NetCDF4Backend`.
