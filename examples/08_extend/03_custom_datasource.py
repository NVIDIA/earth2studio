...
# /// script
# dependencies = [
#   "earth2studio[fcn] @ git+https://github.com/NVIDIA/earth2studio.git@0.19.0",
#   "cartopy",
#   "scipy",
# ]
# ///
...
#
# The [`earth2studio.data.ARCO_ERA5`][earth2studio.data.ARCO_ERA5] data source provides the ERA5 dataset in a cloud
