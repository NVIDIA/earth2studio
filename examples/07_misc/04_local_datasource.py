...
#
# - Prognostic Model: Use the built-in Aurora 6-hour model `earth2studio.models.px.Aurora`.
# - Data source: Pull data from the WeatherBench2 data API `earth2studio.data.WB2ERA5`.
