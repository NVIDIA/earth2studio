...
# Full deterministic workflow from scratch (no earth2studio.run.deterministic).
# Pangu 5-day forecast of z500 and t2m from 2024-03-01 00Z, GFS data, ZarrBackend.
