...
uv init --python=3.12
uv add "earth2studio @ git+https://github.com/NVIDIA/earth2studio.git@0.12.0"
```
...
>>> uv pip install --system --break-system-packages "earth2studio@git+https://github.com/NVIDIA/earth2studio.git@0.12.0"
```
...
uv pip install --system \
    ...
    "earth2studio[all]@git+https://github.com/NVIDIA/earth2studio.git@0.12.0"
```
...
RUN uv pip install --system --break-system-packages "earth2studio@git+https://github.com/NVIDIA/earth2studio.git@0.12.0"
```
