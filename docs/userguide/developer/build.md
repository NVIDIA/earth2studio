...
[Developer Overview](overview.md#developer_overview)). Run all commands below
...
To bump the version automatically, use the following
[hatch commands](https://hatch.pypa.io/1.9/version/):
