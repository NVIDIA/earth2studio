...
Additionally, the lexicon may also be used to track various meta-data / coordinate
fields.
...
Earth2Studio takes a best effort approach to make these meta-data fields standardized
across the package.

Some examples include:

- `lat`: Latitude coordinate of data / observation / sensor
- `lon`: Longitudal coordinate of data / observation / sensor
