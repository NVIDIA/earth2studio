...
class DeterministicWorkflowParameters(WorkflowParameters):
    ...
    # Forecast configuration (strict validation inherited from WorkflowParameters base class)
    ...
    nsteps: int = Field(
        ...
        ge=1,
        le=100,
        description="Number of forecast steps (each step is 6 hours for DLWP)",
    )
...
class DeterministicWorkflow(Workflow):
    ...
    def validate_parameters(
        cls, parameters: dict[str, Any] | DeterministicWorkflowParameters
    ...
    def run(
        self,
        parameters: dict[str, Any] | DeterministicWorkflowParameters,
        execution_id: str,
    ) -> dict[str, Any]:
    ...
    def create_forecast_plot(
        self, io: Any, parameters: DeterministicWorkflowParameters, execution_id: str
    ) -> None:
