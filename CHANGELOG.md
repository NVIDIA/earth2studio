...
- Clarified `CorrDiffCosmoEra5` input preparation: its REA2/REA6 input grid is an
  exact regional subset of standard 0.25-degree ERA5, so both examples now select
  it with `map_coords` instead of interpolating.
