...
try:
    ...
    # AIFS ENS 2.x requires anemoi-models >= 0.9.3
    if Version(anemoi_version) < Version("0.9.3"):
        pytest.skip(
            f"anemoi-models {anemoi_version} not compatible with AIFS ENS 2.x (requires >=0.9.3)",
...
def model() -> AIFS2ENS:
    """Load real AIFS2ENS model from package."""
