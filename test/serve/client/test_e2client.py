...
import torch
import xarray as xr
from api_client.e2client import (
...
class TestRemoteEarth2WorkflowInitialization:
    ...
    def test_initialization(self) -> None:
        ...
        with patch("api_client.e2client.Earth2StudioClient"):
    ...
    def test_initialization_with_client_kwargs(self) -> None:
        ...
        with patch("api_client.e2client.Earth2StudioClient") as mock_client_class:
            RemoteEarth2Workflow(
                base_url="http://localhost:8000",
                workflow_name="test_workflow",
                timeout=60.0,
...
class TestRemoteEarth2WorkflowResult:
    ...
    def test_as_data_source_and_model(self) -> None:
        ...
        with (
            patch("api_client.e2client.Earth2StudioClient") as mock_client_class,
            patch("xarray.open_zarr"),
            patch("api_client.e2client.InferenceOutputSource") as mock_ios_class,
        ):
            mock_client = Mock()
            mock_client_class.return_value = mock_client
...
class TestInferenceOutputModel:
    ...
    def test_create_iterator(self, mock_data_source: Any) -> None:
        ...
        with patch(
            "api_client.e2client.fetch_data",
    ...
    def test_create_iterator_with_lead_time_conversion(
        ...
        with (
            ...
            patch(
                "api_client.e2client._convert_time_to_lead_time",
                return_value=(mock_tensor, mock_coords),
            ) as mock_convert,
        ):
            iterator = model.create_iterator()
