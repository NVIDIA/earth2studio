...
"""Integration-style tests for Microsoft Planetary Computer data sources."""
...
@pytest.mark.slow
@pytest.mark.xfail(reason="Planetary Computer availability varies", raises=Exception)
...
def test_planetary_computer_modis_fire_fetch(time, variable, tile) -> None:
    """Fetch MODIS Fire tiles and ensure outputs match expectations."""
...
def test_planetary_computer_modis_fire_cache(cache: bool) -> None:
    """Ensure MODIS Fire cache directories are created/ignored appropriately."""
